...
//        new TM().predictWithLimitedTrainingSet();
    ...
    public void prepareData() {
        ...
        for (String project : projects) {
            String filePath = originPath + "//data--" + project + ".arff";
    ...
    public void predict(String path) throws Exception {
        ...
        for (int target = 0; target < Settings.projectNames.length; target++) {
            ...
            testDataPath = "Yang_exp_data//origin//data--" + Settings.projectNames[target] + ".arff";
            ...
            for (int source = 0; source < Settings.projectNames.length; source++) {
                trainDataPath = path + "data--" + Settings.projectNames[source] + ".arff";
            ...
            String resultPath = path+"prediction_results\\" + Settings.projectNames[target] + ".txt";
